...
namespace VKBot.Services
{
    public class ImageService
    {
        ...
        {
            _logger = logger;
            fontName = new List<string> { "DejaVu Sans Mono", "Calibri" }.FirstOrDefault(t => SystemFonts.Families.Any(f => f.Name == t)) ?? SystemFonts.Families.Select(t => t.Name).FirstOrDefault();
        }
