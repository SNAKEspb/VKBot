...
namespace MP3Sharp
{
    ...
    public class MP3Stream : Stream
    {
        ...
        // local variables.
        private readonly Buffer16Bit m_Buffer;
        ...
        internal OutputChannelsEnum outputChannels;
        ...
        private bool ReadFrame()
        {
            ...
            try
            {
                ...
                {
                    m_ChannelCountRep = 1;
                    outputChannels = OutputChannelsEnum.BOTH_CHANNELS;
                }
                else
                {
                    m_ChannelCountRep = 2;
                    outputChannels = Format == SoundFormat.Pcm16BitMono ? OutputChannelsEnum.DOWNMIX_CHANNELS : OutputChannelsEnum.BOTH_CHANNELS;
                }

                m_FrequencyRep = header.frequency();

                // Decode the frame.
                ABuffer decoderOutput = m_Decoder.DecodeFrame(header, m_BitStream, outputChannels);
