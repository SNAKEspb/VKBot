...
namespace MP3Sharp.Decoding
{
    ...
    internal class Decoder
    {
        ...
        /// </returns>
        public virtual ABuffer DecodeFrame(Header header, Bitstream stream, OutputChannelsEnum outputChannels)
        {
            if (!m_IsInitialized)
            {
                Initialize(header);
            ...
            IFrameDecoder decoder = RetrieveDecoder(header, stream, layer, outputChannels);
        ...
        protected internal virtual IFrameDecoder RetrieveDecoder(Header header, Bitstream stream, int layer, OutputChannelsEnum outputChannels)
        {
